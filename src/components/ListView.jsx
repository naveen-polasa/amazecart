  ...
  return (
    <section>
      {products.map((product) => {
        ...
        return (
          <article key={id} className="md:flex gap-6 my-4 items-center max-w-5xl lg:px-6 mx-auto">
            <img
              src={image}
              alt={name}
              className="w-72 h-64 rounded-xl border-2 shrink-0 border-slate-300 my-3"
            />
